...
// These are golden tests: they lock CURRENT behavior of agentArgs and
// taskArgs as read directly from args.go / args_shared.go. If an
// expectation here looks surprising, re-check the source before changing
// it — these tests are not a spec, they are a snapshot.
